...
st.header('В.В. Путин 2012-2021. Статистика слов в посланиях Федеральному Собранию.')

kw = st.multiselect('Выберите часть речи', kind_of_words.keys(),['существительное', 'прилагательное','глагол'])
years = st.multiselect('Укажите год:', ['2012','2013','2014','2015','2016','2018','2019','2020','2021'],['2012','2013','2014','2015','2016','2018','2019','2020','2021'])
...
all_years = ['2012','2013','2014','2015','2016','2018','2019','2020','2021']
if years:
